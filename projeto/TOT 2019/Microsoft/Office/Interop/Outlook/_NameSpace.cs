...
public interface _NameSpace
{
  ...
  [DispId(64208)]
  Accounts Accounts { [DispId(64208), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
}
